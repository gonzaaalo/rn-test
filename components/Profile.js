      ...
      <View style={[styles.content, styles.smallContent]}>
        ...
        {editable ?
          <>
            ...
            <Text style={[styles.text, styles.description]}>{"Gender: "}</Text>
            <TextInput
              style={[styles.text, styles.description, styles.input]}
              onChangeText={v => onChange("gender", v)}
              defaultValue={dataCharacter.gender}
            />
            </View>
            <View style={styles.line}>
            <Text style={[styles.text, styles.description]}>{"Birth date: "}</Text>
            <TextInput
              style={[styles.text, styles.description, styles.input]}
              onChangeText={v => onChange("birth_year", v)}
              defaultValue={dataCharacter.birth_year}
            />
            </View>
          ...
          <>
            ...
            <Text style={[styles.text, styles.details, styles.description]}>{dataCharacter.gender}</Text>
